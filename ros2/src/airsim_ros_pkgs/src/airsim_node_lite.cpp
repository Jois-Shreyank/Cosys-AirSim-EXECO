...
int main(int argc, char** argv)
{
    ...
    AirsimROSWrapperLite airsim_ros_wrapper_lite(nh, nh_img, nh_lidar, nh_gpulidar, nh_echo, host_ip, callbackGroup, enable_api_control, enable_object_transforms_list, host_port);
